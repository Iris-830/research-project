...
In Côte d'Ivoire, the 2016 data indicated a fistula prevalence rate of 0.07%, but it was considered underestimated @noauthor_towards_2022. My research, based on 2021 data, shows a prevalence rate of 1.18%, suggesting that the situation may be more severe than previously estimated. For Togo, it reported a prevalence rate of 1%, while my research, using the same year data source, shows a rate of 1.02%, which is consistent.
