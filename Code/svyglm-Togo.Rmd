...
country_data <- subset(data1, country == "Togo")# Design Factors
...
# write.csv(summary_distribution, "Togo_distribution.csv", row.names = FALSE)
```
...
# save as a CSV
# for (var in names(prevalence_list)) {
#   write.csv(prevalence_list[[var]], paste0(var, "_Togo.csv"), row.names = FALSE)
# }
...
for (var in names(prevalence_list)) {
  ...
  variable_bar <- ggplot(df, aes_string(x = var, y = "experienced_fistula1", fill = var)) +
    ...
    geom_text(aes_string(label = "sprintf('%.2f%%', experienced_fistula1 * 100)"), 
              vjust = -0.5, size = 3) +  
    labs(x = var, y = "Prevalence of Fistula", title = paste("Prevalence of Fistula by", var, "in Togo")) +
    theme_minimal() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
# Final Model
glm_country_final <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use,
                   design = svydesign_country, 
                   family = quasibinomial())
...
```{r}
# wealth*age
glm_country_wealth1 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use + wealth*age,
                   design = svydesign_country, 
                   family = quasibinomial())
...
```{r}
# wealth*distance
glm_country_wealth2 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use + wealth*distance,
                   design = svydesign_country, 
                   family = quasibinomial())
...
```{r}
# wealth*number_birth
glm_country_wealth3 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use + wealth*number_birth,
                   design = svydesign_country, 
                   family = quasibinomial())
...
glm_country_wealth4 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + wealth*contraception_use,
                   design = svydesign_country, 
                   family = quasibinomial())
...
```{r}
# education*age
glm_country_education1 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use + education*age,
                   design = svydesign_country, 
                   family = quasibinomial())

summary(glm_country_education1)

# Calculate AIC
AIC(glm_country_education1)

# Calculate confidence intervals
conf_intervals <- confint(glm_country_education1)
print(conf_intervals)
```

```{r}
# education*distance
glm_country_education2 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation + contraception_use + education*distance,
                   design = svydesign_country, 
                   family = quasibinomial())

summary(glm_country_education2)

# Calculate AIC
AIC(glm_country_education2)

# Calculate confidence intervals
conf_intervals <- confint(glm_country_education2)
print(conf_intervals)
```

```{r}
# education*contraception_use
glm_country_education3 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + education*contraception_use,
                   design = svydesign_country, 
                   family = quasibinomial())

summary(glm_country_education3)

# Calculate AIC
AIC(glm_country_education3)

# Calculate confidence intervals
conf_intervals <- confint(glm_country_education3)
print(conf_intervals)
```

```{r}
# occupation*age
glm_country_occupation1 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + occupation*age,
                   design = svydesign_country, 
                   family = quasibinomial())
...
```{r}
# occupation*distance
glm_country_occupation2 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + occupation*distance,
                   design = svydesign_country, 
                   family = quasibinomial())
...
glm_country_occupation3 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + occupation*number_birth,
                   design = svydesign_country, 
                   family = quasibinomial())
...
glm_country_occupation4 <- svyglm(experienced_fistula ~ age + distance + number_birth 
                            + wealth + education + occupation 
                            + contraception_use + occupation*contraception_use,
                   design = svydesign_country, 
                   family = quasibinomial())
